...
<div class="content-header">
    <div class="container-fluid">
        <div class="row mb-2">
            <div class="col-sm-6">
                <h1 class="m-0 text-dark"><b>Add Members</b></h1>
            </div><!-- /.col -->
            <div class="col-sm-6">
        ...
        <form method="post" action="{{ route('admin.members.store') }}">
            ...
            <div class="form-group">
                <div class="row">
                    ...
                    <div class="col-md-6"><input type="email" name="email" class="form-control" value="{{ old('email') }}"></div>    
                    <div class="clearfix"></div> 
                </div> 
            </div> 
            @error('email')
            ...
            <div class="form-group">
                <div class="row">
                    ...
                    <div class="col-md-6"><input type="date" name="doj" class="form-control" value="{{ old('doj') }}"></div>    
                    <div class="clearfix"></div> 
                </div> 
            </div>
            @error('doj')
